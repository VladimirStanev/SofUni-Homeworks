namespace RobotService.Utilities.Messages
{
    public class OutputMessages
    {
        ...
        public const string SupplementCannotBeCreated = "{0} is not compatible with our robotsList.";
        ...
        public const string PerformedSuccessfully = "{0} is performed successfully with {1} robotsList.";
    }
}
